...
int PackSolution()
{
    ...
    var packProperties = $"-c {configuration} -p:StrideSkipAutoPack=true -p:StrideDevPackages=false -nodeReuse:false -p:StrideDevPackagesGenerating=true -p:StridePackAssets=false -o \"{tempPackDir}\" --verbosity normal";
