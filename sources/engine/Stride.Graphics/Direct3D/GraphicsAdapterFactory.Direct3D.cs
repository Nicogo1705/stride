...
namespace Stride.Graphics
{
    public static unsafe partial class GraphicsAdapterFactory
    {
        ...
        internal static void InitializeInternal()
        {
            ...
            // GraphicsAdapterFactory.GpuPreference decides which GPU is enumerated first; the STRIDE_GPU_PREFERENCE
            // environment variable overrides it on a given machine.
